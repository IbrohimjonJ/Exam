      ...
      <div className="flex items-center justify-center gap-11 p-10 flex-wrap">
        ...
        <h2 className="near-footer-title">
          ...
          <p className="p1 text-black">
            ...
            accessories. We have a large showroom and luxury demonstration rooms <br />
            available for you to browse and experience a wide range of our <br />
            products. Stop by our store to meet some of the fantastic people who <br />
            make Audiophile the best place to buy your portable audio equipment <br />
          </p>
        </div>
        <img
        className='img_hero'
